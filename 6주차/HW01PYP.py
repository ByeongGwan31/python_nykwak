...
# total_speed = float(input('이동 시간(h)을 입력하세요 : '))
#
# hours = int(total_speed)
# minutes = int((total_speed - hours) * 60)
# seconds = int(((total_speed - hours) * 60 - minutes) * 60)
#
# distance = average_speed * total_speed
#
